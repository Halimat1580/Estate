...
const contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c10d0020-6ec8-4b87-a8af-faea758121d1");
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
            <div className='flex flex-wrap'>
                <div className='w-full md:w-1/2 text-left'>
                    Your Name
                <input className='w-full border border-gray rounded py-3 px-4 mt-2' type="text" name='Name' placeholder='Your Name' required/>
                </div>

                <div className='w-full md:w-1/2 text-left md:pl-4'>
                    Your Email
                <input className='w-full border border-gray rounded py-3 px-4 mt-2' type="Email" name='Email' placeholder='Your Email' required/>
                </div>
